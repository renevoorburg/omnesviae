...
$data = array(
    ...
    "/nobis" => array (
        ...
        "datasource" => "Η πηγή δεδομένων για τον σχεδιαστή διαδρομών και το εμφανιζόμενο δίκτυο δρόμων είναι ένα αρχείο JSON-LD στο <a href=\"/data/omnesviae.json\">https://omnesviae.org/data/omnesviae.json</a>. Μπορείτε να κατεβάσετε αυτό το αρχείο, να το επεξεργαστείτε για να ταιριάζει με την ερμηνεία σας της TP, και στη συνέχεια να το φορτώσετε στο OmnesViae δείχνοντας την παράμετρο <strong>?datasource</strong> προς αυτό. Για παράδειγμα, χρησιμοποιήστε <a href=\"https://omnesviae.org/?datasource=https://omnesviae.org/data/omnesviae.json\">https://omnesviae.org/?datasource=https://omnesviae.org/data/omnesviae.json</a>, για να φορτώσετε τον προεπιλεγμένο ορισμό. Δείτε <a href=\"https://github.com/renevoorburg/omnesviae\">GitHub</a> για περισσότερες πληροφορίες.",
